...
% [k1, total_max1, position1] = MultiHostOptimize(20000, 100, 1225, server_info_002, vm_info_002, 100, 5, 400, 1, 1);
[k2, total_max2, position2] = MultiHostOptimize(5000, 100, 1225, server_info_002, vm_info_002, 100, 5, 400, 2, 1);
[k3, total_max3, position3] = MultiHostOptimize(5000, 100, 1225, server_info_002, vm_info_002, 100, 5, 400, 3, 1);
% [k4, total_max4, position4] = MultiHostOptimize(20000, 100, 1225, server_info_002, vm_info_002, 100, 5, 400, 4, 1);
